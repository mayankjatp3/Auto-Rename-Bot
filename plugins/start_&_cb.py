...
async def start(client, message: Message):
    ...
    buttons = InlineKeyboardMarkup([
        ...
        [
            ...
            InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ •', url='https://t.me/WarriorUnitsBots')
        ],
        [
    ...
    if data == "home":
        await query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("• ᴍʏ ᴀʟʟ ᴄᴏᴍᴍᴀɴᴅs •", callback_data='help')],
                [InlineKeyboardButton('• ᴜᴘᴅᴀᴛᴇs', url='https://t.me/WarriorUnitsBots'), InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ •', url='https://t.me/WarriorUnitsBots')],
...
async def donation(client, message):
    ...
    yt = await message.reply_photo(photo='https://telegra.ph/file/0c3c0a72ca2785c0cf910.jpg', caption=Txt.DONATE_TXT, reply_markup=buttons)
